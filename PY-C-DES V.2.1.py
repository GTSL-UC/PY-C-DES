# PYCDES Test Script        --- Version 2.1         #
...
#####################################################
    ...
    '''Fluid --- Real == 1, Perfect Gas Eqns == 0''' 
    Fluid     = 1
    '''Fluidtype --- sCO2 == 1, Air == 0'''
    Fluidtype = 1
...
#####################################################
    ...
    typer    = int(result[1])            #Rad Type, 1- Hub, 2- Pitch, 3- Tip
    ...
    Gamma    = float(result[9])          #{-}
    Rgas     = float(result[10]) * 1000  #{J/kgK}
    TCLC     = float(result[11])         #Ratio of Clearance {-}
    Radius   = float(result[12])         #{m}
    if typer == 1 : 
        typert = 'Hub'
    elif typer == 2 : 
        typert = 'Pitch'
        ...
        typert = 'Tip'
    print('**** converted from string to float ****')
...
#####################################################
    ...
    DTT          = [37, 36, 35.5, 34.5, 34.0, 33.0, 47.269] #Old temp data
    ...
    #
        #
        Stage_Number.append(float(result2[1][t]))
        alpha1.append      (float(result2[2][t]))
        MACH1.append       (float(result2[3][t]))
        DH.append          (float(result2[4][t]))    #{kJ/kg}
        R_Phi.append       (float(result2[5][t]))
        S_Phi.append       (float(result2[6][t]))
        R_Sol.append       (float(result2[7][t]))
        S_Sol.append       (float(result2[8][t]))
        Lambda.append      (float(result2[9][t]))
        Bleed.append       (float(result2[10][t]))
        R_AR.append        (float(result2[11][t]))
        S_AR.append        (float(result2[12][t]))
        VZR.append         (float(result2[13][t]))
        R_Coef_Space.append(float(result2[14][t]))
        S_Coef_Space.append(float(result2[15][t]))
        Rad_tip.append     (float(result2[16][t]))
...
#####################################################
#####################################################
# PART B.ii.3 - READ .IGV FILE (OPTIONAL)
#####################################################
#####################################################
    ...
    #
        #
        ANS     = input("Add IGV to calculations? Enter Y or N: ")
        print(' ')
        if ANS == "Y" :
        #
            # 
            ...
            igv_a       = float(result3[3])    #Inlet Angle
            igv_M       = float(result3[4])    #Inlet Mach
            igv_L       = float(result3[5])    #Lambda 
            igv_R_Coef  = float(result3[6])    #Row Space Coef
            igv_rad_tip = float(result3[7])    #Tip Radius
            if Fluid == 1:
                igv_L = igv_L - 0.03 * igv_L 
            #Display IGV Data in Window
            # print('**** IGV DATA ****')
            # print(f' Solidity       = {igv_S} ')
            # print(f' Aspect Ratio   = {igv_AR} ')
            # print(f' Phi Loss Coef  = {igv_Phi} ')
            # print(f' Inlet Angle    = {igv_a} deg')
            # print(f' Inlet Mach     = {igv_M}')
            # print(f' Lambda         = {igv_L} ')
            # print(f' Row Space Coef = {igv_R_Coef}')
            # print(f' Tip Radius     = {igv_rad_tip} m')
            # print(' ')
            #    
        #
        elif ANS == "N" :
    ...
    #Display Input Data in Window
    # print('**** COMPRESSOR INPUT PROPERTIES ****')
    # print(f'Radius type of       = {typer}')
    # print(f'Number of Stages     = {n}')
    # print(f'Mass Flow Rate       = {MFR} kg/s') 
    # print(f'Rev per Minute       = {Rev} rpm')    
    # print(f'Inlet Total P        = {Poi/1000} kPa')   
    # print(f'Inlet Total T        = {Toi} K')    
    # print(f'Alpha at Final       = {alphaend} deg')  
    # print(f'Mach at Final        = {Mend} ')       
    # print(f'Ratio of Spec. Heats = {Gamma} ') 
    # print(f'R of the gas         = {Rgas} J/kgK')
    # print(f'Ratio of Clearance   = {TCLC} ') 
    # print(f'Radius of Hub        = {Radius} m ')
    # print(' ')
    
    # #Display Compressor Data in Window
    # print('**** COMPRESSOR STAGE PROPERTIES ****')
    # print(f' Stage Number         = {Stage_Number} ')
    # print(' ')
    # print(f' Alphas               = {alpha1} deg')
    # print(' ')
    # print(f' Machs                = {MACH1} ')
    # print(' ')
    #print(f' DH                  = {DH} K')
    # print(' ')
    # print(f' Rotor Phi            = {R_Phi} ')
    # print(' ')
    # print(f' Stator Phi           = {S_Phi} ')
    # print(' ')
    # print(f' Rotor Solidity       = {R_Sol} ')
    # print(' ')
    # print(f' Stator Solidity      = {S_Sol} ')
    # print(' ')
    # print(f' Stage Lambda         = {Lambda} ')
    # print(' ')
    # print(f' Stage Bleed          = {Bleed} %')
    # print(' ')
    # print(f' Rotor Aspect Rat     = {R_AR} ')
    # print(' ')
    # print(f' Stator Aspect Rat    = {S_AR} ')
    # print(' ')
    # print(f' Rotor Axial Vel. Rat = {VZR} ')
    # print(' ')
    # print(f' Rotor Space Coef     = {R_Coef_Space} ')
    # print(' ')
    # print(f' Stator Space Coef    = {S_Coef_Space} ')
    # print(' ')
    # print(f' Stage Tip Radius     = {Rad_tip} m')
    
    #DONE WITH IMPORT (FOR NOW)
    #WILL IMPORT OTHER TABLES
                    #CO2 Property Tables
                    #Logical for Radius Type
    #
...
#####################################################
    ...
    FW.write("Viscosity          [Pa/s]   :" + f'{VISCOSITY}' + "\n")
...
#####################################################    
    ...
    FW.write("                                            \n")  
    FW.close
    #print(f'Enthalpy Values         = {Hplot} kJ/kg')    
...
def Inlet_Calculations(STG, MFR, Rev, Poi, Toi, Gamma, Rgas, TCLC, Radius, Stage_Number, MACH1, alpha1, Q, igv_S, igv_AR, igv_Phi, igv_a, igv_M, igv_L, igv_R_Coef, igv_rad_tip, typer, HPT, SPT, APT, RPT, GPT, CpPT, TSH, PSH, Fluid, VPT, Output):
#
    #
    Pi = 3.1415926
    ...
    #NEED TO INCORPORATE RADIUS LOGIC EVENTUALLY 
    #ASSUMING START WITH THE HUB TO START
...
#####################################################
    ...
    #
        ...
        '''
            IF (KKI==4) THEN
           		READ (11,*,END=51) (R(I,1,3),I=1,NS)
            ELSE 
                R(0,1,KI) = R(1,1,KI) = 0.102 m
        	   	R(1,2,KI) = R(1,1,KI) = 0.102 m
	   	        R(1,3,KI) = R(1,1,KI) = 0.102 m
        '''
...
#####################################################
        ...
        '''IGV Outlet Velocity'''
        Vzi_igv2     = Vzi_igv
        Vti_igv2     = Vti_igv * (Radp_igv / Radius)
...
def Rotor_Outlet_Calculations(STG, Stage_Number, DH, DTT, VZR, R_Phi, Lambda, Radius, Radp, RAV, Toi, Vt_h, CP, Vzi, Gamma, Rgas, PTR, Psi, TTR, MFR, HPT, SPT, APT, RPT, GPT, CpPT, TSH, PSH, typer, H, S, Po_h, Fluid, R_Sol, Wi, Wti, Wzi, VPT, Wi_p, Wti_p, Wzi_p):
#
    #
    Pi = 3.1415926
...
#####################################################
    ...
    #
        ...
        '''Go through different radius options in loop...'''
        TTR_2 = TTR_2                                           #{K}
        PTR_2 = PTR_2                                           #{kPa}
        Po_2  = Po_2                                            #{kPa}
        ...
        '''Radius Type'''
        Radh_2, Radp_2, Radt_2, Height_2 = Radius_Type(typer, Radius, A_comp_2, Pi)
...
#####################################################
#####################################################
# PART D.iu - CALCULATIONS (PERFECT GAS)
#####################################################
#####################################################
    ...
    #
        ...
        WTR_2    = ((Rad_2 * Vt_2) / Radp) - (RAV * Radp)
        WZR_2    = Wz_2
        BETAR_2  = math.atan(WTR_2 / WZR_2)
        BETAR_2d = BETAR_2 * (180/Pi)
        WR_2     = WZR_2 / math.cos(BETAR_2)
        PTR_2    = PTR - (R_Phi[STG] * (PTR - Psi))
        TTR_2    = TTR
        Ts_2p    = TTR_2 - (WR_2**2 / (2 * CP))
        AR_2     = (Gamma * Rgas * Ts_2p)**0.5
        MR_2p     = WR_2 / AR_2
        Ps_2p    = PTR_2 / ((TTR_2 / Ts_2p)**(Gamma / (Gamma - 1)))
        RsR_2    = Ps_2p / (Rgas / 1000 * Ts_2p)
        PoR_2    = Ps_2p * ((To_2 / Ts_2p)**(Gamma / (Gamma - 1)))
        A_comp_2 = MFR / (RsR_2 * Vz_2 * Lambda[STG])
    
    
        #Go through different radius options...
        TTR_2 = TTR_2
        PTR_2 = PTR_2
        Po_2  = PoR_2
        ...
        #Radius type
        #(Hub selected:)
        Ps_2  = PTR_2 / ((TTR_2 / Ts_2)**(Gamma / (Gamma - 1))) 
        Rs_2  = Ps_2 / (Rgas / 1000 * Ts_2)
        Rs_2p = Ps_2p/ (Rgas / 1000 * Ts_2p)
        ...
        Vz_2p    = Vz_2
        U_2p     = RAV * Radp_2
        Vt_2p    = Vt_2 * Rad_2 / Radp_2
        ALPHA_2p = math.atan(Vt_2p / Vz_2p)
        ALPHA_2pd= ALPHA_2p * (180/Pi)                          #{deg}  
        V_2p     = Vz_2p / math.cos(ALPHA_2p)
        Wt_2p    = Vt_2p - U_2p
        Wz_2p    = Vz_2p
        BETA_2p  = math.atan(Wt_2p / Wz_2p)
        BETA_2pd = BETA_2p * (180/Pi)
        W_2p     = Wz_2p / math.cos(BETA_2p)
        M_2p     = V_2p / AR_2
        Rm_2     = Radp_2
        Vtheta_2 = Vt_2
        Dht_2    = CP * DTT[STG]
        ...
        # #CONSTANT HUB VELO TRIANGLES
        # U_2h, ALPHA_2h, V_2h, Vt_2h, Vz_2h, BETA_2h, W_2h, Wt_2h, Wz_2h, Po_2h, To_2h, Ts_2h, Ps_2h, M_2h, A_2h, Rs_2h = VELO_TRIANGLES(HPT, SPT, RPT, APT, TSH, PSH, Vz_2, Vt_2, RAV, Radh_2, Radp_2, To_2, Po_2, Gamma, CP, Rgas)
...
#####################################################
    ...
    print(f'Radius at Rotor Exit  = {round(Rad_2, 3)} m')
...
def Stator_Outlet_Calculations(n, alphaend, Mend, STG, alpha1, MACH1, Radius, To_2, H_2, Gamma, S_Phi, Po_2, Ps_2, Rgas, MFR, Lambda, RAV, CP, Bleed, Poi, HPT, SPT, APT, RPT, GPT, CpPT, TSH, PSH, Fluid, V_2p, Vt_2p, S_Sol, VPT):
#
    #
    Pi = 3.1415926
...
#####################################################
    ...
    #
        ...
        H_3      = H_2
        To_3     = To_2
        Ts_3     = To_3 / (1 + (((Gamma - 1) / 2) * M_3**2))
        Po_3     = Po_2 - (S_Phi[STG] * (Po_2 - Ps_2))
        Ps_3     = Po_3 / ((To_3 / Ts_3)**(Gamma / (Gamma - 1)))
        A_3      = (Gamma * Rgas * Ts_3)**0.5
        V_3      = M_3 * A_3
        Vz_3     = V_3 * math.cos(ALPHA_3)
        Vt_3     = V_3 * math.sin(ALPHA_3)
        Rs_3     = Ps_3 / (Rgas / 1000 * Ts_3)
        Ro_3     = Po_3 / (Rgas / 1000 * To_3)
        A_comp_3 = MFR / (Rs_3 * Vz_3 * Lambda[STG])
        S_3      = float(SPT(Po_3, To_3))
        h_3      = H_3 - (V_3**2 / 2)
        #
    ...
    DF = 1 - (V_3/V_2p) + (abs(Vt_2p - Vt_3) / (2*S_Sol[STG]*V_2p))
    
    #Loop for Radius Types
    #Const Hub
    Radt_3   = ((A_comp_3 / Pi) + Rad_3**2)**0.5
    Height_3 = Radt_3 - Rad_3
    Radp_3   = Rad_3 + Height_3 / 2
    ...
    U_3      = RAV * Radp_3
    Wt_3     = Vt_3 - U_3
    BETA_3   = math.atan(Wt_3 / Vz_3)
    BETA_3d  = BETA_3 * (180 / Pi)
    W_3      = Vz_3 / math.cos(BETA_3)
    Wz_3     = Vz_3
...
#####################################################
    ...
    #CONSTANT HUB VELO TRIANGLES
    U_h3, ALPHA_h3, V_h3, Vt_h3, Vz_h3, BETA_h3, W_h3, Wt_h3, Wz_h3, Po_h3, To_h3, Ts_h3, Ps_h3, M_h3, A_h3, Rs_h3 = VELO_TRIANGLES(HPT, SPT, RPT, APT, TSH, PSH, Vz_3, Vt_3, RAV, Rad_3, Radp_3, To_3, Po_3, Gamma, CP, Rgas, Fluid)
...
#####################################################    
    ...
    '''
    return Rad_3, Radp_3, To_3, Po_3, Ts_h3, Ps_3, Vt_h3, Vz_h3, PTR_3, TTR_3, MFR, H_3, S_3, PR, Po_h3, Rs_3, V_3, Vz_3, Vt_3, ALPHA_3d, BETA_3d, Rad_3, Ts_h3, Ps_h3, Rs_h3, To_h3, Po_h3, M_h3, V_h3, Vz_h3, Vt_h3, ALPHA_h3, BETA_h3, Radt_3, Ts_t3, Ps_t3, Rs_t3, To_t3, Po_t3, M_t3, V_t3, Vz_t3, Vt_t3, ALPHA_t3, BETA_t3, Rs_3, Ts_3, M_3, U_3, W_h3, Wt_h3, Wz_h3, DF, h_3, GammaValue, Viscosity, W_3, Wt_3, Wz_3, W_t3, Wt_t3, Wz_t3, CCPP, Height_3
    #
#
...
def Radius_Type(typer, Radius, Area, Pi): 
    ...
    #
        ...
        #
            #
            print('ERROR - Hub Radius is less than one, cannot continue.')
            sys.exit()
            #
        #
        Radt  = Radp + (Height / 2)
    ...
    #
        ...
        #
            #
            print('ERROR - Tip radius is too small, cannot continue.')
            sys.exit()
            #
        #
        Radh   = rterm**0.5
...
def VELO_TRIANGLES(HPT, SPT, RPT, APT, TSH, PSH, VZ, VT, RAV, R, RI, To, Po, Gamma, CP, Rgas, Fluid):
    ...
    if Fluid == 1: 
        ...
        h_2     = H_2 - (V_2**2 / 2)
        Ts_2    = float(TSH(S_2, h_2))
        Ps_2    = float(PSH(S_2, h_2))
        A_2     = float(APT(Ps_2, Ts_2))
        Rs_2    = float(RPT(Ps_2, Ts_2))
        M_2     = V_2 / A_2                         #{ }
...
def EXTRAPOLATION(XA, XB, XC, XD, YA, YB, YC, YD): 
    #Takes 4 points from the coordinates and extrapolates to 
...
def PLOTS(n, Pplot, Tplot, Fluidtypename, Rplot, Hplot, Splot, HH, SS, RAD, PT, PS, TT, TS, RS, VV, VZV, VTV, ALP, BET, CAMBER, MACHSP, MACHSH, MACHST, LOADING_C, FLOW_C, DIFFUSION, FILE, Poi_initial, Toi_initial, AD_EFF_perstage, Value_Reaction, RADh, RADt, GAMMAVALUE, VISCOSITY, SPECIFICHEAT, X_CROSS_SECTION, Y_CROSS_SECTION, STAGGERANGLE1_h, STAGGERANGLE1_p, STAGGERANGLE1_t, STAGGERANGLE2_h, STAGGERANGLE2_p, STAGGERANGLE2_t, ZETAANGLE_hD, ZETAANGLE_pD, ZETAANGLE_tD, AXIAL_WIDTH_R, CHORD_LENGTH_R, RAR_R, ROTORWIDTH_h, ROTORWIDTH_p, ROTORWIDTH_t, NBR, STAGGERANGLE1_Sh, STAGGERANGLE1_Sp, STAGGERANGLE1_St, STAGGERANGLE2_Sh, STAGGERANGLE2_Sp, STAGGERANGLE2_St, ZETAANGLE_ShD, ZETAANGLE_SpD, ZETAANGLE_StD, AXIAL_WIDTH_S, CHORD_LENGTH_S, RAR_S, STATORWIDTH_h, STATORWIDTH_p, STATORWIDTH_t, NBS, X_HUB, Y_HUB, X_TIP, Y_TIP, X_BLADES, Y_BLADES, X_ROTOR, Y_ROTOR, X_STATOR, Y_STATOR, IGV_Q, RHUB, ZHUB, RTIP, ZTIP, refl): 
    ...
    #AXIAL_WIDTH_R, CHORD_LENGTH_R, RAR_R, ROTORWIDTH_h, ROTORWIDTH_p, ROTORWIDTH_t, NBR
